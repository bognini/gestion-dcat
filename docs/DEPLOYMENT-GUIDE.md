...
docker run -d --name gestion_dcat_app \
  -p 3000:3000 \
  -e DATABASE_URL="postgresql://admindcatdb:DcatSecure2024Pass@host.docker.internal:5432/gestion_dcat?schema=public" \
  -e AUTH_SECRET="Gestion_DCAT_Super_Secret_Key_2024_Production_Xk9Lm2" \
...
```env
# Database
DATABASE_URL="postgresql://admindcatdb:DcatSecure2024Pass@db:5432/gestion_dcat?schema=public"
POSTGRES_USER=admindcatdb
POSTGRES_PASSWORD=DcatSecure2024Pass
POSTGRES_DB=gestion_dcat

# Authentication
AUTH_SECRET=Gestion_DCAT_Super_Secret_Key_2024_Production_Xk9Lm2
